...
public class SFTP {
    ...
    private static final Logger logger = LogManager.getFormatterLogger(SFTP.class);
	...
	public static ChannelSftp setupSFTPChannel(Session session, String sftpPath) throws Exception {
		...
		channelSftp.connect();
		try {
			logger.info("alreaded created...!");

			//System.out.println("alreaded created...");
			channelSftp.cd(sftpPath);

		} catch (SftpException e) {
			logger.error("Path not found: " , sftpPath);
		}
	...
	public static void main(String[] args) {
		...
		String sftpHost = "10.1.42.127";
		int sftpPort = 30034;
		String sftpUserName = "admin";
		String sftpPassword = "mtn123456";
