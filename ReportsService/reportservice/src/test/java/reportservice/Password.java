...
public class Password {
	...
	@Test(dataProvider = "PasswordReport",retryAnalyzer = com.tecnotree.automatiom.listerns.RetryAnalyzer.class)
	...
	@Test(dataProvider = "PasswordReportZip",retryAnalyzer = com.tecnotree.automatiom.listerns.RetryAnalyzer.class)
	...
	@DataProvider(name = "PasswordReport")
	...
	@DataProvider(name = "PasswordReportZip")
	public Object[] dataproviders2() throws FileNotFoundException {
		return requestpayload.getData1("PasswordReportZip.json", "dataSet","templateName");
	}
